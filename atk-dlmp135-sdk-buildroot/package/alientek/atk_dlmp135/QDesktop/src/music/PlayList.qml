        ...
        ListView {
            ...
            delegate: Rectangle {
                ...
                Text {
                    ...
                    color: parent.ListView.isCurrentItem && musicPlayer.playbackState == Audio.PlayingState ? "#f29c9f" : "black"
                    font.pixelSize: 25
                ...
                Text {
                    ...
                    text: "     " + author
                    elide: Text.ElideRight
                    color: parent.ListView.isCurrentItem && musicPlayer.playbackState == Audio.PlayingState ? "#f29c9f" : "gray"
                    font.pixelSize: 15
                    font.family: "Montserrat Light"
