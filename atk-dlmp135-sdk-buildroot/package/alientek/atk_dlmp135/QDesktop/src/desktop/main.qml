...
ApplicationWindow {
    ...
    onGlobal_appIndexChanged: {
        ...
        case 0:
            normalStartApp("Music", "Recorder", "正在关闭录音应用", true, "qrc:/images/appinit_images/music.png", "black", false, true)
            break;

        case 1 :
            normalStartApp("Ov_Camera", "", "", false, "", "black", false, true)
            break;
        ...
        case 4 :
            normalStartApp("VideoPlayer", "", "", false, "", "black", false, true)
            break;

        case 5 :
            normalStartApp("Adc", "", "", false, "", "black", false, true)
            break;

        case 6 :
            normalStartApp("Wifi", "", "", false, "", "black", false, true)
            break;
        ...
        case 10 :
            normalStartApp("Calculator", "", "", false, "", "black", false, true)
            break;
...
*/
    ...
    Button {
        ...
        height: 80
        background: Image {
            source: whiteOrGray ? "qrc:/icons/btn_icons/btn_clear_white.png" : "qrc:/icons/btn_icons/btn_clear_gray.png"
            anchors.centerIn: parent
            width: 32
            height: 32
        }
        ...
        states: State {
            name: "show"; when: bt_clear.pressed
            PropertyChanges { target: bt_clearbg; opacity: 0.3; width: parent.width}
        }
